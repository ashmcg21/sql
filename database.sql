...
UPDATE accounts SET account_balance = 10.00 WHERE "id" = 5;

-- 4. How do you select all users that have attempted 9 or more transactions?
SELECT * FROM "accounts"
WHERE "transactions_attempted" > '10'
...
VALUES
        (or manually by going to the table and clicking "+row" in the bottom left)
...
WHERE transactions_completed <5 AND city = 'Phoenix' 



--STRETCH GOALS:
   -- 1. UPDATE accounts SET "city" = 'Santa Fe' WHERE "id" = 5;
   -- 2. DELETE FROM accounts WHERE "username" = 'Grace'
   -- 3. 
